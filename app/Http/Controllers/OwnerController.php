...
class OwnerController extends Controller
{
    ...
    public function dashboard(){
        ...
        return view('pages/owner/dashboard',compact('user','member','transaksi','outlet','baru','selesai','proses'));
    }
    ...
    public function list_user(){
        ...
        return view('pages/owner/manage_user/list_user',compact('user'));
    }
    public function delete_user($id){
        ...
        return redirect('/owner/list_user');
    }
    public function tambah_user(){
        $no = 0;
        $outlet = DB::table('outlet')->where('id_outlet', '<>', 0)->get();

        return view('pages/owner/manage_user/tambah_user',compact('outlet'));
    }
    ...
    public function edit_user($id){
        ...
        return view('/pages/owner/manage_user/edit_user',compact('user','outlet'));
    ...
    public function list_outlet(){
        ...
        return view('/pages/owner/manage_outlet/list_outlet',compact('outlet'));
    }
    public function tambah_outlet(){

        $outlet = DB::table('outlet')->where('id_outlet', '<>', 0)->get();

        return view('pages/owner/manage_outlet/tambah_outlet',compact('outlet'));
    ...
    public function upload_outlet(Request $request){
        ...
        return redirect('/owner/list_outlet');
    ...
    public function edit_outlet($id){
        ...
        return view('/pages/owner/manage_outlet/edit_outlet',compact('outlet'));
    ...
    public function outlet_pdf(){
        ...
        $pdf = PDF::loadview('/pages/owner/manage_outlet/outlet_pdf',compact('outlet','tanggal'));
    ...
    public function list_member(){
        ...
        return view('/pages/owner/manage_member/list_member',compact('member'));
    }

    public function tambah_member(){

        return view('pages/owner/manage_member/tambah_member');
    ...
    public function upload_member(Request $request){
        ...
        return redirect('/owner/list_member');
    ...
    public function edit_member($id){
        ...
        return view('/pages/owner/manage_member/edit_member',compact('member'));
    ...
    public function member_pdf(){
        ...
        $pdf = PDF::loadview('/pages/owner/manage_member/member_pdf',compact('member','tanggal'));
    ...
    public function list_paket(){
        ...
        return view('/pages/owner/manage_paket/list_paket',compact('paket','outlet'));
    }
    ...
    public function tambah_paket(){
        ...
        return view('/pages/owner/manage_paket/tambah_paket',compact('outlet'));
    ...
    public function upload_paket(Request $request){
        ...
        return redirect('/owner/list_paket');
    ...
    public function edit_paket($id){
        ...
        return view('/pages/owner/manage_paket/edit_paket',compact('paket','outlet'));
    ...
    public function paket_pdf(Request $request){
        ...
        $pdf = PDF::loadview('/pages/owner/manage_paket/paket_pdf',compact('paket','tanggal','outlet'));
    ...
    public function menu_transaksi(){
        ...
        return view('/pages/owner/manage_transaksi/menu_transaksi',compact('outlet'));
    }
    ...
    public function list_transaksi($id){
        ...
        return view('/pages/owner/manage_transaksi/list_transaksi',compact('transaksi','outlet_id','total_semua'));
    }
    ...
    public function tambah_transaksi($id){
        ...
        return view('pages/owner/manage_transaksi/tambah_transaksi',compact('outlet','member','id_transaksi','transaksi','paket','detail','total','tr'));
    ...
    public function upload_transaksi($outlet){
        ...
        return redirect('/owner/list_transaksi/tambah_transaksi/'.$id);
    }
    ...
    public function update_transaksi(Request $request){
        ...
        return redirect('/owner/list_transaksi/tambah_transaksi/'.$request->id_transaksi);
    ...
    public function delete_transaksi($id){
        ...
        return redirect('/owner/list_transaksi');
    }
    public function edit_transaksi($id){

        $transaksi = DB::table('transaksi')->where('id_transaksi',$id)->first();

        return view('/pages/owner/manage_transaksi/edit_transaksi',compact('Transaksi'));
    ...
    public function bayar_transaksi($id){
        ...
        return redirect('/owner/'.$outlet.'/list_transaksi');
    ...
    public function update_status1(Request $request){
        ...
        return redirect('/owner/detail_transaksi/'.$request->id_transaksi);
    ...
    public function update_bayar(Request $request){
        ...
        return redirect('/owner/'.$outlet->id_outlet.'/list_transaksi');
    }
    ...
    public function transaksi_pdf(Request $request){
        ...
        $pdf = PDF::loadview('/pages/owner/manage_transaksi/transaksi_pdf',compact('transaksi','awal','akhir','total_semua','cek','tanggal','outlet'));
    ...
    public function tambah_detail($id){
        ...
        return view('pages/owner/manage_transaksi/tambah_detail',compact('transaksi','paket','detail','total'));
    ...
    public function detail_transaksi($id){
        ...
        return view('/pages/owner/manage_transaksi/detail_transaksi',compact('transaksi','detail','total'));
    ...
    public function invoice($id){
        ...
        $pdf = PDF::loadview('/pages/owner/manage_transaksi/invoice',compact('transaksi','detail','total','tanggal'));
