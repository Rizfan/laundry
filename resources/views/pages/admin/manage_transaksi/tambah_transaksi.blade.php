	...
	<div class="col col-md-12">
		<div class="card shadow">
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data" action="/admin/tambah_transaksi/update_bayar">
					@csrf
...
<div class="row">
	<div class="col col-md-4">
		<div class="card shadow">
			...
			<form method="POST" enctype="multipart/form-data" action="/admin/tambah_transaksi/update">
				@csrf
				<div class="card-body">
	...
	<div class="col col-md-4">
		<div class="card shadow">
			...
			<form method="POST" enctype="multipart/form-data" action="/admin/tambah_transaksi/update_biaya">
				@csrf
				<div class="card-body">
					<input type="hidden" name="id_transaksi" value="{{$id_transaksi}}">
					<div class=" form-group row mb-4">
